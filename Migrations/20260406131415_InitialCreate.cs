    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "A = Fix-rate per employee, B = Workday-rate", "ServiceChargeVersion", new DateTime(2026, 4, 6, 13, 14, 15, 157, DateTimeKind.Utc).AddTicks(4210), "A" },
                    { 2, "Company / property name", "CompanyName", new DateTime(2026, 4, 6, 13, 14, 15, 157, DateTimeKind.Utc).AddTicks(4210), "My Hotel" },
                    { 3, "Whether initial setup has been completed", "Onboarded", new DateTime(2026, 4, 6, 13, 14, 15, 157, DateTimeKind.Utc).AddTicks(4210), "false" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new TimeSpan(0, 8, 0, 0, 0), new TimeSpan(0, 17, 0, 0, 0), 15000m, "Food and Beverage", 25m, "Morning", 9m },
                    { 2, new TimeSpan(0, 7, 0, 0, 0), new TimeSpan(0, 16, 0, 0, 0), 12000m, "Cleaner", 20m, "Morning", 9m },
                    { 3, new TimeSpan(0, 8, 0, 0, 0), new TimeSpan(0, 17, 0, 0, 0), 18000m, "Receptionist", 30m, "Morning", 9m },
                    { 4, new TimeSpan(0, 8, 0, 0, 0), new TimeSpan(0, 17, 0, 0, 0), 35000m, "Manager", 25m, "Morning", 9m }
                });
